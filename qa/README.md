...
Every pull request to the Bluehost Core repository is built and run through
...
```
  ...
  --srcdir=SRCDIR       Source directory containing bluehostd/aither-cli
                        (default: ../../src)
...
blocks (25*500=12500 BHP) in its wallet.
