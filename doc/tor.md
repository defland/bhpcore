...
1. Run Aither Core behind a Tor proxy
----------------------------------

The first step is running Aither Core behind a Tor proxy. This will already make all
...
2. Run a Aither Core hidden server
-------------------------------
...
your aitherd's P2P listen port (9999 by default).
	...
	-externalip=X   You can tell Aither Core about its publicly reachable address using
...
3. List of known Aither Core Tor relays
------------------------------------
...
Aither Core has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
Aither Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if Aither Core is listening, and
