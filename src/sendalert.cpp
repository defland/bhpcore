...
2. run bluehostd with -printalert or -sendalert like this:
   /path/to/bluehostd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.aithercoin.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Bluehost Core:0.12.0.58/"));
