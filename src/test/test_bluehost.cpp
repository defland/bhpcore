...
#define BOOST_TEST_MODULE Bluehost Test Suite

#include "test_aither.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_aither_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
