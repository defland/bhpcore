    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bluehost Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bluehost Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bluehost-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bluehost in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BHP, 0.1 BHP, 1 BHP and 10 BHP -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://aithercoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://aithercoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bluehost Core is shutting down...") + "<br /><br />" +
