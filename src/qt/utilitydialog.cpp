    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Aither Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Aither Core"));
...
All the Aither in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Aither Core is shutting down...") + "<br /><br />" +
