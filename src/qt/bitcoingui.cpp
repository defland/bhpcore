    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bluehost Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bluehost address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aither: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bluehost Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bluehost Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bluehost Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bluehost addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bluehost addresses"));
    ...
    openAction->setStatusTip(tr("Open a aither: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bluehost Core help message to get a list with possible Bluehost Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bluehost Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bluehost network", "", count));
    } else {
...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, bool header)
{
    ...
    if (fDebug) LogPrintf("bitcoingui.cpp:1024 masternodeSync.IsBlockchainSynced(): %s\n",masternodeSync.IsBlockchainSynced());
...
{
    QString strTitle = tr("Bluehost Core"); // default title
