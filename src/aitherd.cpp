 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Bluehost (https://www.aithercoin.com/),
 * which enables instant payments to anyone, anywhere in the world. Bluehost uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        std::string strUsage = _("Bluehost Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n";
    ...
    try
    {
        ...
        if (fDaemon)
        {
            fprintf(stdout, "Bluehost Core server starting\n");
